    ...
    return (
        <section className='px-6 py-20 md:px-20'>
            ...
            <div className='flex items-center justify-center mx-auto my-5'>
                <button onClick={() => { navigate('/artisans'); scrollTo(0, 0) }} className=" btn btn-primary py-4 flex items-center w-full sm:w-[30%] text-center justify-center gap-3">View All <BsArrowRight /></button>
            </div>

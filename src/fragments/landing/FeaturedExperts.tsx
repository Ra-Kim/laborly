...
const FeaturedExperts = () => {
  ...
  return (
    <section className="px-6 py-20 md:px-20">
      <h2 className="text-gray-900 font-secondaryFont text-2xl sm:text-3xl md:text-4xl font-bold text-center">
        Featured <span className="text-primary">Laborly</span> Experts
      </h2>
      ...
      <div className="flex items-center justify-center mx-auto my-5">
        <button
          ...
          className=" btn btn-primary py-4 flex items-center w-full sm:w-[30%] text-center justify-center gap-3"
        >
